...
public class StainedTreeBlocks {
    ...
    public static final Leaves BLACK_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves BLUE_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves BROWN_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves CYAN_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves GRAY_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves LIGHT_BLUE_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves LIGHT_GRAY_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves LIME_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves MAGENTA_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves ORANGE_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves PINK_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
    public static final Leaves PURPLE_LEAVES = new Leaves(FabricBlockSettings.copyOf(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.GRASS));
